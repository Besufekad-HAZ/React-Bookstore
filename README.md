...
["Bookstore-App"] :- "Bookstore App" is an online bookstore Single Page App (SPA) that allows users to:
...
cd my-folder
git clone git@github.com:Besufekad-HAZ/React-Bookstore.git (SSH)
...
Feel free to check the [issues page](https://github.com/Besufekad-HAZ/React-Bookstore/issues).
...
--> I would like to thank the Microverse team for allowing us to work on this Bookstore App project.
